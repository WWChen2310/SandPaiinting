	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_Tex = packedInput.ase_texcoord1.xy * _Tex_ST.xy + _Tex_ST.zw;
				
				surfaceDescription.Color = tex2D( _Tex, uv_Tex ).rgb;
